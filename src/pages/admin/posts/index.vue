...
<template>
    <div>
        ...
        <div class="mb-4 flex text-right">
            <router-link :to="{ name: 'admin.posts.create' }" class="border border-gray-700 p-4 mb-4">
                Create Posts
            </router-link>
        </div>
        <div>
                        ...
                        <tr v-for="post in postStore.posts">
                            ...
                            <td class="bg-white border-b-border-gray-200 text-left p-2">
                                <div class="flex">
                                    ...
                                    <div>
                                        <svg @click.prevent="postStore.deletePost(post)" xmlns="http://www.w3.org/2000/svg"
